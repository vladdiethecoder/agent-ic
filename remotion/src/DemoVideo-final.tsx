...
import { runPayload, editPlan, captions } from './data-final';

const { introFrames, mainFrames, outroFrames, callouts } = editPlan;

export const DemoVideoFinal = () => {
  ...
  return (
    <AbsoluteFill style={{ backgroundColor: '#050608', fontFamily: 'Inter, sans-serif' }}>
      ...
      <Sequence from={introFrames} durationInFrames={mainFrames}>
        <Video
          src={staticFile('ui-final.webm')}
          startFrom={0}
          endAt={mainFrames}
          style={{ width: '100%', height: '100%', objectFit: 'contain' }}
        />
        <Audio src={staticFile('voiceover-final.wav')} startFrom={0} endAt={mainFrames} />
