...
const safetyOpsCase = {
  ...
  missionStatement:
    'We receive hundreds of vehicle safety complaints every month. Our analysts manually read and route each one into severity queues — critical safety review, general safety review, technical, or manual intake. This takes 6 minutes per case at $92/hour loaded. Sentinel Routing Inc. is selling us RouteGuard AI, which claims it can auto-route complaints with 90% accuracy. Before we sign a $14,400 annual contract, we want to trial it on real data with a $100 spend cap. Can it actually deliver?',
...
const securityOpsCase = {
  ...
  policyEnvelope: {
    ...
    blockedTool: {
      ...
      targetUri: 'https://blocked-webhook.invalid/redacted-slack-webhook',
      attemptedAmount: 0,
