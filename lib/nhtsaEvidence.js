...
export function loadNhtsaComplaintsEvidence({ rootDir = NHTSA_COMPLAINTS_RUN_DIR } = {}) {
  ...
  return {
    ...
    metricSources: {
      ...
      governedEnvelopeDollars: 'Stripe test-mode governed envelope authorized for the service trial',
      ...
      spendConsumed: 'actual Stripe test-mode spend consumed; authorized envelope remains separate',
