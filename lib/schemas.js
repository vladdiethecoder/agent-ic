...
export const ProviderStateSchema = z.object({
  state: z.enum(['live', 'available', 'unavailable', 'handoff', 'local-proof', 'error', 'test', 'demo', 'pending']),
  mode: z.enum(['live', 'capability-check', 'unavailable', 'demo-disabled', 'local-policy', 'test', 'artifact']),
  detail: z.string().optional(),
});
...
export const StripeReceiptSchema = z.object({
  state: z.string(),
  mode: z.enum(['live', 'demo', 'test']).optional(),
...
export const HermesReceiptSchema = z.object({
  state: z.string(),
  mode: z.enum(['live', 'demo', 'artifact']).optional(),
  playbookId: z.string(),
  taskId: z.string(),
