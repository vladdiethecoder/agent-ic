...
test('policy store creates diffs activates and evaluates policy versions', async () => {
  ...
  const sim = policyStore.evaluatePolicy({ policy: base, attemptedAction: { name: 'CARFAX vehicle-history report', attemptedAmount: 150 } });
