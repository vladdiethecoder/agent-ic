...
function checkPackageScripts() {
  ...
  for (const script of ['lint', 'test', 'build', 'prod:check', 'security:scan', 'security:audit', 'store:backup', 'migrate:apply', 'migrate:check', 'openapi:check', 'container:check', 'release:check', 'submission:preflight', 'public:export']) {
