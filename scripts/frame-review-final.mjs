...
function buildVisionPrompt() {
  return [
    ...
    'Separate deterministic OCR and frame gates already found no local/private text, no black frames, no long silence, and required terms for Agent IC, service trial, NHTSA, Hermes, Nemotron, Stripe, cs_test, 403, SKILL.md, and Run from playbook.',
...
async function main() {
  ...
  check('No local/private text in contact-sheet OCR', forbidden.length === 0, forbidden.length ? forbidden.join(', ') : 'clean');
