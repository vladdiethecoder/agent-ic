...
const manifest = {
  ...
  scripts: {
    ...
    proofStripe: pkg.scripts['proof:stripe'],
    proofNemotron: pkg.scripts['proof:nemotron'],
    proofPolicy: pkg.scripts['proof:policy'],
    proofProductionAccess: pkg.scripts['proof:production-access'],
    proofHermes: pkg.scripts['proof:hermes'],
  },
  gates: {
    lint: 'npm run lint',
    test: 'npm test',
    ...
    proofStripe: 'npm run proof:stripe',
    proofNemotron: 'npm run proof:nemotron',
    proofPolicy: 'npm run proof:policy',
    proofProductionAccess: 'npm run proof:production-access',
  },
  ...
  productionReadiness: {
    ...
    strictProofRequiredInProduction: true,
    proofSurfaces: ['stripe', 'nemotron', 'policy', 'production-access', 'hermes', 'playbook'],
  },
};
