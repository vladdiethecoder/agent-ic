...
const audioPath = 'remotion/public/agent-ic-audio-mastered-v14.wav';
const captionsPath = 'remotion/src/captions-v14.json';
const timestampsPath = 'demo-out/stage-timestamps-v14.json';
const planPath = 'remotion/edit-plan-v14.json';
...
async function findUiDuration() {
  const candidates = ['demo-out/ui-v14.webm', 'remotion/public/ui-v14.webm'];
...
async function main() {
  ...
  const baseTerminalOverlays = template.terminalOverlays || [
    {
      name: 'hermes-health',
      src: 'terminals-v14/hermes-health.mp4',
      startFrame: stageLabels.find((s) => s.stageId === 'proposal')?.startFrame || 450,
      endFrame: clampFrame((stageLabels.find((s) => s.stageId === 'proposal')?.startFrame || 450) + 270, mainFrames),
      x: 1180,
      y: 140,
      width: 680,
      height: 420,
    ...
    },
    {
      ...
      src: 'terminals-v14/stripe-cli-checkout.mp4',
    ...
    },
    {
      ...
      src: 'terminals-v14/nemoclaw-gate-403.mp4',
  ...
  const plan = {
    ...
    uiDuration,
    uiSrc: 'ui-v14.webm',
    audioSrc: 'agent-ic-audio-mastered-v14.wav',
    cursorEventsSrc: 'cursor-events-v14.json',
    captionsSrc: 'captions-v14.json',
  ...
  const manifestPath = 'demo-out/video-text-manifest-v14.txt';
  const manifest = [
    'CONTINUE',
    '$185,000',
    '$100',
