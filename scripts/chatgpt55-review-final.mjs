...
const REVIEWS = [
  ...
  },
  {
    ...
    focus: [
      ...
      'Fail for localhost, 127.0.0.1, :3000, /home/vdubrov, Hackathon Submission #1, vladdiethecoder, DevTools, noAutoRun, or stale agent-ic-hermes-hackathon.',
...
async function buildEvidenceBundle() {
  ...
  return [
    ...
    qrPage,
    '',
    'Forbidden visible/proof markers already scanned clean by deterministic QA: localhost, 127.0.0.1, :3000, /home/vdubrov, private handles, stale repo URL, raw cents copy, STRIPE LIVE, HERMES ERROR, NEMOCLAW ERROR, and local/demo overclaim markers.',
  ].join('\n');
}
