#!/usr/bin/env node
/**
 * Generate the final voiceover from demo/voiceover-final.txt.
 *
...
const inputFile = process.argv[2] || 'demo/voiceover-final.txt';
const outputFile = process.argv[3] || 'remotion/public/voiceover-final.wav';
